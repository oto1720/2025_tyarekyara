...
class StatisticsNotifier extends Notifier<StatisticsState> {
  ...
  Future<void> loadUserStatistics(String userId) async {
    ...
    try {
      ...
      final u = await repo.fetchUserStatistics(userId);
      final d = await repo.fetchDiversityScore(userId);
      final s = await repo.fetchStanceDistribution(userId);
      final t = await repo.fetchParticipationTrend(userId);
